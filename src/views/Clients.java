...
public class Clients {
    ...
    public static void main(String[] args) {
        Student student1 = new Student("1", "Nguyễn Văn A", 20, "Nam", "Hà Nội", 9.0);
        Student student2 = new Student("2", "Nguyễn Thị B", 20,"Nữ", "Hà Nội", 8.0);
        Student student3 = new Student("3", "Trần Văn C", 20, "Nam", "Hà Nội", 7.0);
        Student student4 = new Student("4", "Trần Thị D", 20, "Nữ", "Hà Nội", 8.0);
        Student student5 = new Student("5", "Nguyễn Quốc Triệu", 20, "Nam", "Hà Tây", 9.0);
